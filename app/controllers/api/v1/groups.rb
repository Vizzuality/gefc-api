    ...
    class Groups < Grape::API
      ...
      resource :groups do
        ...
        params do
          ...
          optional :load_nested_data, type: Boolean, desc: "If full nested data should be loaded as well. This may cause very slow response times for large datasets", default: false
        end
        get ":id", root: "group" do
          group_object = FetchGroup.new.by_id_or_slug(permitted_params[:id])
          if params["load_nested_data"]
