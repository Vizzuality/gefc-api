namespace :import do
  ...
  task all: :environment do
    ...
    ENV["file_name"] = groups_file_name
    Rake::Task["groups:import_csv"].invoke if groups_file_name
    widgets_file_name = ENV["widgets_file_name"]
    ENV["file_name"] = widgets_file_name
    Rake::Task["widgets:import_json"].invoke if widgets_file_name
